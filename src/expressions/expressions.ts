...
function peg$parse(input, options) {
    ...
    var peg$f10 = function (expr, tail) {
        return buildConditionalExpression(expr, tail);
    };
    var peg$f11 = function (expr, tail) {
    ...
    var peg$f24 = function (expr, list) {
        return [expr, ...list];
    };
    var peg$f25 = function (expr) {
        return expr;
    };
    var peg$f26 = function (str) {
        return str;
    };
    ...
    var peg$f36 = function () {
        return { type: 'IntegerLiteral', value: convertToInt64(text()) };
    };
